...
# implementation from the portfolio add of build wallet address with the source and pool from the portofolio delta
this.portfolioAdded.attach(_ => this.onPortfolioAdded( this.Implementation("com.walletconnect:android-core:$CORE_VERSION"))
...
object Wallet {
    ...
    sealed class Params {
        ...
        data class SessionApprove(
            ...
            val namespaces: Map<String, Model.Portofolio.Session>,
